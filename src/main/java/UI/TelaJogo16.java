 ...
 * @author 23.01425-3
 */
public class TelaJogo16 extends javax.swing.JFrame {
    ...
    public TelaJogo16(){}
    public TelaJogo16(String ra,Jogo jogo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(aparecidoIconLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 80, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaJogo16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaJogo16().setVisible(true);
            }
        });
    }
