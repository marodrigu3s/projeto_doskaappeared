 ...
 * @author 23.01425-3
 */
public class TelaJogo12 extends javax.swing.JFrame {
    ...
    public TelaJogo12(){}
    public TelaJogo12(String ra,Jogo jogo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(aparecidoIconLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 180, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaJogo12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaJogo12().setVisible(true);
            }
        });
    }
