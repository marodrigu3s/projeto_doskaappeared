 ...
 * @author 23.01425-3
 */
public class TelaJogo5 extends javax.swing.JFrame {
    ...
    public TelaJogo5(){}
    public TelaJogo5(String ra,Jogo jogo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(aparecidoIconLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 510, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaJogo5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
