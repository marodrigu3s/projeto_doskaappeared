 ...
 * @author 23.01425-3
 */
public class TelaJogo9 extends javax.swing.JFrame {
    ...
    public TelaJogo9(){}
    public TelaJogo9(String ra,Jogo jogo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(aparecidoIconLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 290, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaJogo9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
