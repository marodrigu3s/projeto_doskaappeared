 ...
 * @author 23.01425-3
 */
public class TelaJogo10 extends javax.swing.JFrame {
    ...
    public TelaJogo10(){}
    public TelaJogo10(String ra,Jogo jogo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(aparecidoIconLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 290, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaJogo10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaJogo10().setVisible(true);
            }
        });
    }
